...
async def k8s_apply(context: str, yaml_content: str, namespace: Optional[str] = None) -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            "status": "Success",
            "message": f"Successfully {action} {kind} '{name}'",
            "resource": result
        }
    except ApiException as e:
...
async def k8s_patch(context: str, resource_type: str, name: str, patch: Dict[str, Any], namespace: Optional[str] = None) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        if resource_type in ['pod', 'pods']:
            ...
            result = api_instance.patch_namespaced_pod(
                name=name,
                namespace=namespace,
                body=patch
            )
            ...
            api_instance = client.CoreV1Api(api_client)
            result = api_instance.patch_namespaced_service(
                name=name,
                namespace=namespace,
                body=patch
            )
            ...
            api_instance = client.CoreV1Api(api_client)
            result = api_instance.patch_namespaced_config_map(
                name=name,
                namespace=namespace,
                body=patch
            )
            ...
            api_instance = client.CoreV1Api(api_client)
            result = api_instance.patch_namespaced_secret(
                name=name,
                namespace=namespace,
                body=patch
            )
...
async def k8s_label(context: str, resource_type: str, name: str, labels: Dict[str, str], 
                   namespace: str, overwrite: Optional[bool] = False) -> Dict[str, Any]:
    """
...
async def k8s_annotate(context: str, resource_type: str, name: str, annotations: Dict[str, str], 
                      namespace: str, overwrite: Optional[bool] = False) -> Dict[str, Any]:
    """
